...
type SchedulerTerminate struct {
	subcommands.SubcommandBase
	socketPath string
}

func (cmd *SchedulerTerminate) Parse(ctx *appcontext.AppContext, args []string) error {
...
func (cmd *SchedulerTerminate) Execute(ctx *appcontext.AppContext, repo *repository.Repository) (int, error) {
